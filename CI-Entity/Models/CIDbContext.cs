...
public partial class CIDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA4141BC6A7B11");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C34CF5699C5");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A833D895FB");
        ...
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B52F804B7CC");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E7957687C52DBFBE");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD055F3C2B922");
        ...
        {
            entity.HasKey(e => e.FavouriteMissionId).HasName("PK__favorite__94E4D8CA19829F34");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C7956CB918");
        ...
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB2FE50A620");
        ...
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838AC59AF0B0");
        ...
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80E0CC85A2A6E26");
        ...
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED158B83C54BE");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E87AE3362B");
        ...
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E51724751AB02");
        ...
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___82712008DB02B9B9");
        ...
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5ACFCDB3B41");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA8379C8642E7D");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C565D4F96B1");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__04497867A0802A3C");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053C1BD3F13A");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF5068CC7DD76E");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__users__B9BE370F30660E0F");
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576B7D600FA0");
